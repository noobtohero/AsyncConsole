...
> [!IMPORTANT]
> **การเปิดใช้งาน**: คุณต้องทำการ `#define DEBUG_MODE` ไว้ที่บรรทัดบนสุดของไฟล์ (ก่อน include) หรือกำหนดใน `platformio.ini` มิฉะนั้นคำสั่ง `CONSOLE_` ต่างๆ จะไม่มีการทำงานใดๆ และโค้ดจะถูกตัดออกจาก Binary ทันทีครับ
